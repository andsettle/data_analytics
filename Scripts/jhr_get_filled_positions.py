...
request_url = "https://api.resumatorapi.com/v1/jobs/status/filled"
...
data_frame.to_excel("jan_filled_slots.xlsx", index=False)
subprocess.run(["open", "jan_filled_slots.xlsx"])